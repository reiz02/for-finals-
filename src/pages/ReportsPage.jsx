...
const ReportsPage = () => {
  ...
  const handleGenerateReport = () => {
    ...
    const filtered = submissions.filter((item) => {
      ...
      return itemDate.getFullYear().toString() === selectedYear && allowedMonths.includes(itemDate.getMonth());
    });
    setFilteredSubmissions(filtered);
    calculateTotals(filtered); 
  };

  // --- RESTORED PDF FORMAT (ENGLISH) ---
  const exportToPDF = () => {
    const doc = new jsPDF();
    ...
    <div style={styles.container}>
      ...
      <div style={styles.card}>
        <div style={{display: "flex", gap: "10px", flexWrap: "wrap"}}>
          <select style={{...styles.input, width: "150px"}} value={selectedYear} onChange={(e) => setSelectedYear(e.target.value)}><option value="2026">2026</option></select>
